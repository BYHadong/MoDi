...
data class Diaries(val weather : String, val feel : String, val contents : String, val createdAt : String)
data class DiariesGet(val status : Result, val diaries : List<Diaries>)

//mainactivity Recyclerview data class
class Diarielist(val days : String, val feel : String, val weather : String, val contents : String)